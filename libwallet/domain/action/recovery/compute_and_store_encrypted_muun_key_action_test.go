...
func TestComputeAndStoreEncryptedMuunKeyAction(t *testing.T) {
	...
	t.Run("routes to correct storage slot based on proof", func(t *testing.T) {
		...
		for _, tc := range testCases {
			t.Run(tc.desc, func(t *testing.T) {
				...
				vmkJson := testutils.BuildVerifiableMuunKeyJson( //nolint:staticcheck // TODO: var vmkJson should be vmkJSON
					keys,
					tc.withProof,
				)
	...
	t.Run("overwrites existing key on second run", func(t *testing.T) {
		...
		// First run
		vmkJson1 := testutils.BuildVerifiableMuunKeyJson( //nolint:staticcheck // TODO: var vmkJson1 should be vmkJSON1
			keys,
			true,
		)
		...
		vmkJson2 := testutils.BuildVerifiableMuunKeyJson( //nolint:staticcheck // TODO: var vmkJson2 should be vmkJSON2
			keys,
			true,
		)
