...
extension MonetaryAmount {
    ...
    /// If you have the complete currency use toAmountPlusCode(btcCurrencyFormat:currencyOfAmount:)
    /// instead.
    ...
    func toAmountPlusCode(btcCurrencyFormat: BitcoinCurrencyFormat = .long) -> String {
        ...
        return toAmountPlusCode(
            btcCurrencyFormat: btcCurrencyFormat,
            currencyOfAmount: currencyFromCode
        )
    }

    func toAmountPlusCode(
        btcCurrencyFormat: BitcoinCurrencyFormat = .long,
        currencyOfAmount: Currency
    ) -> String {
        let amountString = currencyOfAmount.toAmountWithoutCode(
            amount: amount,
            btcCurrencyFormat: btcCurrencyFormat
        )
    ...
    func toAmountWithoutCode(
        ...
        return currencyOfAmount.toAmountWithoutCode(
            amount: amount,
            btcCurrencyFormat: btcCurrencyFormat
        )
    }

    /// If you have the complete currency use
    /// toAmountWithoutCode(btcCurrencyFormat:,currencyOfAmount:) instead.
    /// > Warning: This method will default fiat for formatting if currency is not found.
    /// Default bitcoinUnit will be use in case of Bitcoin.
